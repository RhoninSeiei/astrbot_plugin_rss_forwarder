...
AstrBot v4.24.1 以降では、`プラグイン詳細 -> ソース診断` から Plugin Page を開けます。旧バージョンの AstrBot には Plugin Pages がありませんが、ポーリング機能と `/rss probe` コマンドは引き続き利用できます。診断結果では次の 4 モードを使用します。
